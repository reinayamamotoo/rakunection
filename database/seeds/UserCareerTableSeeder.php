...
1,'EC','営業・コンサルタント','','2012','2014',null, 
...
3,'EC','戦略・経営企画','','2012','2014','数名のECCとテストプロジェクトを立ち上げました。彼らの日常的なタレントマネジメントや仕事の進め方を学び、改善を見込める点についていくつかのアイデアを試しました。', 

3,'EC','営業・コンサルタント','','2008','2012',null, 

4,'EC','物流・SCM','リーダー','2000','2001',null, 

5,'EC','アプリケーションエンジニア','','2011','2018','一つはユーザーが求める商品をより見つけやすくするためのUIやUXの改善、もう一つは「楽天市場」に出店している店舗向けのマーティングツールおよびサービスの開発', 
...
8,'EC','営業・コンサルタント','プロデューサー','2013','2018',null, 

8,'EC','マーケティング','','2009','2013',null, 
...
10,'EC','戦略・経営企画','','2006','2010',null, 

11,'EC','物流・SCM','マネージャー','2007','2008',null, 

12,'EC','アプリケーションエンジニア','ディレクター','2007','2009',null, 
...
15,'トラベル','マーケティング','','2013','2015','航空系サイトやメタサーチサイト、福利厚生サイトなどの外部パートナーや媒体と連携し「楽天トラベル」へ集客', 

15,'トラベル','営業・コンサルタント','マネージャー','2008','2013','旅行サービスの手配・運用、システムやウェブサイトなどのマネジメント業務全般', 

16,'トラベル','営業・コンサルタント','マネージャー','2013','2015','西日本エリアの統括', 

17,'トラベル','戦略・経営企画','ディレクター','2013','2014','事業のマネージャーとして仕入れやプロダクト開発、システム改善、ウェブマーケティングなどをリード', 

17,'トラベル','営業・コンサルタント',null,'2008','2013',null, 
...
20,'トラベル','戦略・経営企画','リーダー','2015','2018','数名のECCとテストプロジェクトを立ち上げました。彼らの日常的なタレントマネジメントや仕事の進め方を学び、改善を見込める点についていくつかのアイデアを試しました。', 

20,'トラベル','データサイエンティスト・リサーチャー','','2012','2015','データサイエンスの視点から、楽天における膨大な「データ」というツールを最大限に活用し、様々な方法でより良いサービスを実現するためのソリューションを提供', 

21,'トラベル','その他','マネージャー','2010','2018',null, 

22,'トラベル','マーケティング','ディレクター','1997','1998','トラベルコやトラベルjp、トリップアドバイザー、大きい所ではJALやANAなどのパートナーサイトと一緒に 共同キャンペーンを組んだり、アフィリエイト連携', 

23,'トラベル','営業・コンサルタント','マネージャー','1998','1999',null, 

24,'トラベル','戦略・経営企画','リーダー','1999','2000','旅行会社向けに、手配オペレーションや業務プロセス設計などを担当', 

25,'トラベル','物流・SCM','','2000','2001','', 

26,'トラベル','アプリケーションエンジニア','プロデューサー','2009','2018','', 

27,'トラベル','データサイエンティスト・リサーチャー','ディレクター','2007','2018','', 

28,'トラベル','その他','プロデューサー','2003','2004','', 

29,'FinTech','マーケティング','リーダー','2004','2005','楽天スーパーポイントをフックにしたユーザー参加型のキャンペーンを展開', 

30,'FinTech','営業・コンサルタント','','2005','2006','多くの中小企業に向けて、投資関連の営業を、中部地方を中心に担当', 
...
32,'FinTech','戦略・経営企画','ディレクター','2007','2008','FinTech関連の大幅な戦略変更に伴ったプロジェクトで、買収後の金融会社の戦略・方向性の決定を担当した', 
...
33,'FinTech','アプリケーションエンジニア','マネージャー','2010','2017','社内向けシステムを作るエンジニアの統括を主に担当', 
...
35,'FinTech','その他','','2010','2011','経理部門として、日々の支出計算の管理を担当。また、決算前後の期間では、決算報告資料の元データの編集も行った。', 
...
39,'FinTech','物流・SCM','リーダー','2014','2015','', 

39,'FinTech','営業・コンサルタント','プロデューサー','2016','2018','', 

40,'FinTech','アプリケーションエンジニア','','2015','2016','', 

40,'FinTech','営業・コンサルタント','リーダー','2017','2018','', 

41,'FinTech','データサイエンティスト・リサーチャー','マネージャー','2016','2017','リコメンドロジック等のデータサイエンスソリューションの開発に従事', 

41,'FinTech','営業・コンサルタント','マネージャー','2014','2018','', 

42,'FinTech','その他','ディレクター','2017','2018','', 
...
44,'新サービス','営業・コンサルタント','リーダー','1998','1999','', 

45,'新サービス','戦略・経営企画','','1999','2003','大まかに2つの役割を担っていました。1つはMCO（メディア＆コミュニケーションズカンパニー）における事業開発と、もう1つはCEO戦略・イノベーション室（CEIO）の一員としての業務です。', 

45,'EC','アプリケーションエンジニア','マネージャー','2003','2018','一つはユーザーが求める商品をより見つけやすくするためのUIやUXの改善、もう一つは「楽天市場」に出店している店舗向けのマーティングツールおよびサービスの開発', 

46,'新サービス','物流・SCM','マネージャー','2000','2001','', 
...
48,'新サービス','データサイエンティスト・リサーチャー','プロデューサー','2002','2003','', 

49,'新サービス','その他','リーダー','2003','2004','', 
...
51,'新サービス','営業・コンサルタント','マネージャー','2005','2006','', 

52,'新サービス','戦略・経営企画','ディレクター','2006','2007','結婚式の前撮りに関するサービスを立案する機会をいただき、実現させることができました。イチから画面の仕様や機能、必要な特徴を洗い出し、約3カ月でサービスの立ち上げを行いました。', 

53,'新サービス','物流・SCM','プロデューサー','2007','2008','', 
...
54,'新サービス','アプリケーションエンジニア','リーダー','2015','2018','', 

55,'新サービス','データサイエンティスト・リサーチャー','','2009','2010','', 

56,'新サービス','その他','マネージャー','2010','2011','', 

57,'RIT','マーケティング','ディレクター','2011','2012','', 
...
62,'RIT','データサイエンティスト・リサーチャー','ディレクター','2016','2017','', 
...
64,'RIT','マーケティング','リーダー','1997','1998','', 

65,'RIT','営業・コンサルタント','','1998','1999','', 

66,'RIT','戦略・経営企画','マネージャー','2008','2016','', 

67,'RIT','物流・SCM','ディレクター','2012','2017','', 
...
69,'RIT','データサイエンティスト・リサーチャー','リーダー','2002','2003','', 

70,'RIT','その他','','2003','2004','', 

71,'コーポレート','マーケティング','マネージャー','2004','2005','', 

72,'コーポレート','営業・コンサルタント','ディレクター','2005','2008','', 
...
75,'コーポレート','アプリケーションエンジニア','','2008','2009','', 
...
78,'コーポレート','マーケティング','プロデューサー','2011','2012','リサーチ統括部 総合調査グループにリサーチャーとして配属され、日本国内と海外の各種マーケティング調査を担当', 

79,'コーポレート','営業・コンサルタント','リーダー','2012','2013','ドローンを使用した宅配サービスの設置個所のハンティングや、新規参入店舗の獲得', 

80,'コーポレート','戦略・経営企画','','2013','2014','企画部のミッションは、3年後の成長に向けて、経営課題を構想から実行までドライブすること。三木谷社長やECカンパニー経営陣と経営課題や解決策について議論させて頂き、その実現まで責任を持ってリードしていきます。', 

81,'コーポレート','物流・SCM','マネージャー','2014','2015','', 
...
82,'コーポレート','アプリケーションエンジニア','ディレクター','2015','2016','', 
