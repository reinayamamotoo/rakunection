            ...
            {!! Form::open(['route' => 'search.get', 'method' => 'get']) !!}
                ...
                function btn3_click(){
                    ...
                    if (!d2.hasChildNodes()){
                        ...
                        var div_element_6 = document.createElement("div");
                        var div_element_7 = document.createElement("div");
                        ...
                        ='<input type="text" name="keyword_university" value="" size="" placeholder="大学名"> <br>';
                        div_element_6.innerHTML 
                        = '<span>入社年で絞り込み</span><br><div class="form_year" id="keyword_start"> {{ Form::selectRange('keyword_start', date('Y')-21, date('Y')+0, null, ['class' => 'form-control', 'placeholder'=>'年から']) }} </div>';
                        div_element_7.innerHTML 
                        = '<div class="form_year"> {{ Form::selectRange('keyword_end', date('Y')-21, date('Y')+0, null, ['class' => 'form-control', 'placeholder'=>'年まで']) }} </div>';
                        ...
                        d2.appendChild(div_element_6);
                        d2.appendChild(div_element_7);
                    }
                }
                function btn4_click(){
                    var d2 = document.getElementById('search_detail');
